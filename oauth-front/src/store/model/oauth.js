...
/**
 *
 * Created by huangyinhuang on 2017/9/1.
 *
 * OAuth2 store
 *
 */
...
const actions = {
    ...
    fetchClientList({commit, dispatch}) {
        api.oauthService.getClientList().then(function (resp) {
    ...
    fetchClientsByPage({commit, dispatch}, data) {
        api.oauthService.getClientsByPage(data).then(function (resp) {
            if (resp.data != null && resp.data.code != null && resp.data.code >= 0) {
    ...
    updateClient({dispatch}, data) {
        api.oauthService.updateClient(data.clientInfo).then(function (resp) {
    ...
    deleteClient({dispatch}, data) {
        api.oauthService.deleteClient(data).then(function (resp) {
            dispatch("fetchClientsByPage", data.queryParam);
            dispatch("displayPromptByResponseMsg", resp);
        }.bind(this)).catch(function (err) {
            dispatch("displayPromptByResponseMsg", err.response);
    ...
    registerClient({dispatch}, data){
        api.oauthService.registerClient(data).then(function (resp) {
            dispatch("displayPromptByResponseMsg", resp);
        }.bind(this)).catch(function (err) {
            dispatch("displayPromptByResponseMsg", err.response);
        }.bind(this));
    ...
    fetchUserList ({commit, dispatch}) {
        api.oauthService.getUserList().then(function (resp) {
            if (resp.data != null && resp.data.code != null && resp.data.code >= 0) {
    ...
    fetchUsersByPage({commit, dispatch}, data) {
        api.oauthService.getUsersByPage(data).then(function (resp) {
            if (resp.data != null && resp.data.code != null && resp.data.code >= 0) {
    ...
    fetchAccessTokenList({commit, dispatch}) {
        api.oauthService.getIssuedAccessTokens().then(function (resp) {
            if (resp.data != null && resp.data.code != null && resp.data.code >= 0) {
    ...
    fetchAccessTokensByPage({commit, dispatch}, data) {
        api.oauthService.getAccessTokensByPage(data).then(function (resp) {
            if (resp.data != null && resp.data.code != null && resp.data.code >= 0) {
    ...
    revokeAccessToken({dispatch}, data) {
        api.oauthService.revokeAccessToken(data).then(function (resp) {
    ...
    fetchRefreshTokenList ({commit, dispatch}) {
        api.oauthService.getIssuedRefreshTokens().then(function (resp) {
            if (resp.data != null && resp.data.code != null && resp.data.code >= 0) {
    ...
    fetchRefreshTokensByPage ({commit, dispatch}, data) {
        api.oauthService.getRefreshTokensByPage(data).then(function (resp) {
            if (resp.data != null && resp.data.code != null && resp.data.code >= 0) {
    ...
    revokeRefreshToken({dispatch}, data) {
        api.oauthService.revokeRefreshToken(data).then(function (resp) {
    ...
    fetchMyClients ({commit, dispatch}, data) {
        api.oauthService.getMyClients(data).then(function (resp) {
            if (resp.data != null && resp.data.code != null && resp.data.code >= 0) {
    ...
    updateMyClient({dispatch}, data) {
        api.oauthService.updateClient(data.client).then(function (resp) {
    ...
    fetchMySessions({commit, dispatch}, data) {
        api.oauthService.getMySessions(data).then(function (resp) {
            if (resp.data != null && resp.data.code != null && resp.data.code >= 0) {
    ...
    fetchSessionsByPage({commit, dispatch}, data) {
        api.oauthService.getSessionsByPage(data).then(function (resp) {
            if (resp.data != null && resp.data.code != null && resp.data.code >= 0) {
    ...
    revokeSession({dispatch}, data) {
        api.oauthService.revokeSession(data).then(function (resp) {
    ...
    fetchAuthCodeList({commit, dispatch}) {
        api.oauthService.getAllAuthCodes().then(function (resp) {
            if (resp.data != null && resp.data.code != null && resp.data.code >= 0) {
    ...
    fetchAuthCodesByPage({commit, dispatch}, data) {
        api.oauthService.getAuthCodesByPage(data).then(function (resp) {
            if (resp.data != null && resp.data.code != null && resp.data.code >= 0) {
    ...
    fetchMyAuthCodes({commit, dispatch}, data) {
        api.oauthService.getMyAuthCodes(data).then(function (resp) {
            if (resp.data != null && resp.data.code != null && resp.data.code >= 0) {
    ...
    revokeAuthCode({dispatch}, data) {
        api.oauthService.revokeAuthCode(data).then(function (resp) {
    ...
    fetchMyAccessTokens ({commit, dispatch}, data) {
        api.oauthService.getMyAccessTokens(data).then(function (resp) {
            if (resp.data != null && resp.data.code != null && resp.data.code >= 0) {
    ...
    fetchMyRefreshTokens ({commit, dispatch}, data) {
        api.oauthService.getMyRefreshTokens(data).then(function (resp) {
            if (resp.data != null && resp.data.code != null && resp.data.code >= 0) {
    ...
    verifyClient({commit, dispatch}, data) {
        api.oauthService.introspectClient(data).then(function (resp) {
            if (resp.data != null && resp.data.code != null && resp.data.code >= 0) {
    ...
    fetchAuthCode({commit, dispatch}, data) {
        api.oauthService.generateAuthCode(data).then(function (resp) {
    ...
    fetchAuditLogsByPage({commit, dispatch}, data) {
        api.oauthService.getAuditLogsByPage(data).then(function (resp) {
            if (resp.data != null && resp.data.code != null && resp.data.code >= 0) {
