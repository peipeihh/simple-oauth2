CREATE DATABASE IF NOT EXISTS `simple_oauth` DEFAULT CHARSET utf8 COLLATE utf8_general_ci;

CREATE TABLE IF NOT EXISTS `simple_oauth`.`user` (
...
CREATE TABLE IF NOT EXISTS `simple_oauth`.`user_security_action`(
...
CREATE TABLE IF NOT EXISTS `simple_oauth`.`audit_log`(
...
CREATE TABLE IF NOT EXISTS `simple_oauth`.`authorization_code` (
  ...
  `client_id` varchar(256) NOT NULL COMMENT '颁发给应用开发的Client ID',
  `insert_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `insert_by` varchar(64) DEFAULT NULL COMMENT '创建者',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `update_by` varchar(64) NULL COMMENT '最近修改者',
...
CREATE TABLE IF NOT EXISTS `simple_oauth`.`authentication_holder` (
  `id` bigint(20) AUTO_INCREMENT PRIMARY KEY COMMENT '授权持有者主键ID',
  `user_id` BIGINT COMMENT '用户ID',
  `approved` BOOLEAN COMMENT '是否同意',
  `redirect_uri` varchar(2048) COMMENT '重定向URL',
  `client_id` varchar(256) NOT NULL COMMENT '颁发给应用开发的Client ID',
  `insert_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `insert_by` varchar(64) DEFAULT NULL COMMENT '创建者',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
CREATE TABLE IF NOT EXISTS `simple_oauth`.`refresh_token` (
...
CREATE TABLE IF NOT EXISTS `simple_oauth`.`client` (
  ...
  `client_id` varchar(256) NOT NULL COMMENT '颁发给应用开发的Client ID',
  `client_secret` varchar(2048) NOT NULL COMMENT '颁发给应用开发的Client Secret',
  `basic_auth` varchar(256) NOT NULL COMMENT '颁发给应用开发的Basic Auth',
  `redirect_url` varchar(2048) NOT NULL COMMENT '应用Client的重定向Url',
...
CREATE TABLE IF NOT EXISTS `simple_oauth`.`approved_site` (
  `id` BIGINT AUTO_INCREMENT PRIMARY KEY COMMENT '主键ID',
  `user_name`  varchar(128) NOT NULL COMMENT '登录通过的用户名或者用户邮箱',
  `client_id` varchar(256) NOT NULL COMMENT '申请访问的应用Client ID',
  `insert_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `insert_by` varchar(64) DEFAULT NULL COMMENT '创建者',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `update_by` varchar(64) NULL COMMENT '最近修改者',
...
CREATE TABLE IF NOT EXISTS `simple_oauth`.`scope` (
  `id` BIGINT AUTO_INCREMENT PRIMARY KEY COMMENT '主键ID',
...
CREATE TABLE IF NOT EXISTS `simple_oauth`.`approved_site_scope` (
  `id` BIGINT AUTO_INCREMENT PRIMARY KEY COMMENT '主键ID',
  `approved_site_id` BIGINT NOT NULL COMMENT '用户登录通过站点ID',
  `scope_name` varchar(256) COMMENT '域Scope名字',
  `insert_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `insert_by` varchar(64) DEFAULT NULL COMMENT '创建者',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `update_by` varchar(64) NULL COMMENT '最近修改者',
...
CREATE TABLE IF NOT EXISTS `simple_oauth`.`client_scope` (
  `id` BIGINT AUTO_INCREMENT PRIMARY KEY COMMENT '主键',
  `client_id` varchar(256) NOT NULL COMMENT '颁发给应用开发的Client ID',
  `scope_name` varchar(256) NOT NULL COMMENT '域Scope名字',
  `insert_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `insert_by` varchar(64) DEFAULT NULL COMMENT '创建者',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `update_by` varchar(64) NULL COMMENT '最近修改者',
