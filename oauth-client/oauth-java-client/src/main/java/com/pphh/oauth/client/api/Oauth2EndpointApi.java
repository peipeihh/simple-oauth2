...
import com.pphh.oauth.client.ProgressResponseBody;
import com.pphh.oauth.client.model.OAuth2AccessToken;
import com.pphh.oauth.client.model.ValidityVO;
import com.pphh.oauth.client.ApiCallback;
import com.pphh.oauth.client.ApiClient;
import com.pphh.oauth.client.ApiException;
import com.pphh.oauth.client.ApiResponse;
import com.pphh.oauth.client.Configuration;
import com.pphh.oauth.client.Pair;
import com.pphh.oauth.client.ProgressRequestBody;
...
public class OAuth2EndpointApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call issueTokenUsingPOST1Call(String grantType, String authorization, String code, String redirectUri, String refreshToken, String username, String password, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call issueTokenUsingPOST1ValidateBeforeCall(String grantType, String authorization, String code, String redirectUri, String refreshToken, String username, String password, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = issueTokenUsingPOST1Call(grantType, authorization, code, redirectUri, refreshToken, username, password, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<OAuth2AccessToken> issueTokenUsingPOST1WithHttpInfo(String grantType, String authorization, String code, String redirectUri, String refreshToken, String username, String password) throws ApiException {
        com.squareup.okhttp.Call call = issueTokenUsingPOST1ValidateBeforeCall(grantType, authorization, code, redirectUri, refreshToken, username, password, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call issueTokenUsingPOST1Async(String grantType, String authorization, String code, String redirectUri, String refreshToken, String username, String password, final ApiCallback<OAuth2AccessToken> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = issueTokenUsingPOST1ValidateBeforeCall(grantType, authorization, code, redirectUri, refreshToken, username, password, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<OAuth2AccessToken>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
